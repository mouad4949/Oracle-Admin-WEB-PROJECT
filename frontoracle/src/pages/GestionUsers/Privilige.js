...
const Privilige = () => {
    ...
    const fetchPrivileges = async () =>{
        try{
            const response = await axios.get("http://localhost:8080/Privilege");
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold mb-4 text-red-700">Gestion des Privilèges</h2>
            {privileges.length > 0 ?(
                            ...
                            { privileges.map((privilege)=>(
                                ...
                                <tr key={privilege.id}>
                                    ...
                                    <td  className="px-6 py-4 whitespace-nowrap" >
                                        <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-2"  ><FiTrash2/></button>
                                    </td>
                                </tr>
